...
<div class="min-h-screen bg-[#F8FAFC] pb-20" x-data="blogPost()">
    ...
    <div class="sticky top-0 z-[50] bg-white/80 backdrop-blur-xl border-b border-slate-200">
        <div class="max-w-[1700px] mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="h-8 w-px bg-slate-200"></div>
                <button type="submit" form="createPostForm" class="flex items-center gap-2 px-6 py-2.5 bg-slate-900 hover:bg-purple-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest transition-all shadow-lg shadow-slate-900/10 active:scale-95">
    ...
    <form id="createPostForm" action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" class="max-w-[1700px] mx-auto px-6 py-10">
        @csrf
                ...
                <div class="sticky top-32 space-y-1">
                    ...
                    <div class="pt-8 block">
                        <div class="px-4 space-y-4">
                            <div class="p-4 bg-purple-50 rounded-2xl border border-purple-100 text-purple-900">
                                <p class="text-[9px] font-black mb-1 uppercase tracking-widest">İPUCU</p>
                                <p class="text-[11px] font-medium leading-relaxed opacity-80">60 karakterden kısa başlıklar Google'da daha iyi performans gösterir.</p>
                            </div>
                        </div>
                    </div>
                </div>
