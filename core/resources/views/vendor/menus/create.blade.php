...
<div class="bg-gray-50 min-h-screen py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Yeni Menü/Hizmet Ekle</h1>
                <p class="text-gray-500">Müşterilerinize sunacağınız yeni bir ürün veya hizmet oluşturun.</p>
            </div>
        </div>

        <form action="{{ route('vendor.menus.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden" x-data="{ price: '' }">
            @csrf
            ...
            <div class="p-8 space-y-6">
                ...
                <div class="w-full">
                    ...
                    <div class="relative w-full h-48 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300 hover:border-primary transition flex items-center justify-center cursor-pointer overflow-hidden group">
                        ...
                        <div class="text-center pointer-events-none" id="upload-placeholder">
                            ...
                            <span class="text-sm text-gray-500">Fotoğraf seçmek için tıklayın</span>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition" placeholder="Örn: Adana Kebap" required>
                    </div>
                    <div x-data="{ isCustom: false }">
                        ...
                        <div class="relative">
                            ...
                            <div x-show="isCustom" class="flex gap-2" x-cloak>
                                <input type="text" name="category" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition" placeholder="Yeni Kategori Adı (Örn: Kokteyller)" :disabled="!isCustom">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition" placeholder="İçindekiler, detaylar...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="relative flex-1">
                            <input type="number" step="0.01" name="price" x-model="price" class="w-full px-4 py-3 pl-10 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition font-bold text-lg" placeholder="0.00" required>
