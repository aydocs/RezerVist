...
@section('title', 'Şifre Sıfırlama Kodunuz')
...
@section('content')
    <div style="text-align: center;">
        ...
        <p>Merhaba <strong>{{ $user_name }}</strong>,<br>Endişelenmeyin! Aşağıdaki tek kullanımlık kod ile şifrenizi güvenli bir şekilde sıfırlayabilirsiniz.</p>
        
        <div class="card" style="text-align: center;">
            <div class="card-title">SIFIRLAMA KODU</div>
        ...
        <p style="font-size: 14px; margin-bottom: 0;">Eğer bu talebi siz yapmadıysanız lütfen bu e-postayı dikkate almayın.</p>
    </div>
@endsection
