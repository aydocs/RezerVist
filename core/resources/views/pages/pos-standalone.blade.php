...
<head>
    ...
    <title>RezerVistA POS | Türkiye'nin En İyi Adisyon ve POS Sistemi</title>
    <meta name="description" content="RezerVistA POS - Yeni Nesil Restoran Yönetim Sistemi">
    <meta name="keywords" content="pos, restoran pos, adisyon sistemi">
...
<body class="antialiased font-sans bg-white">
    ...
    <main>
        <div class="bg-[#fcfcfd] text-slate-600 selection:bg-primary selection:text-white font-sans overflow-x-hidden">
            ...
            <div class="absolute top-0 left-0 w-full h-[1500px] pointer-events-none -z-10 overflow-hidden text-slate-600">
                ...
                <div class="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.03] mix-blend-multiply"></div>
            </div>
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8 grid lg:grid-cols-2 gap-24 items-center">
                    <div class="relative z-10 text-center lg:text-left">
                        ...
                        <div class="flex flex-wrap gap-5 items-center justify-center lg:justify-start">
                            <a href="{{ route('pages.pos.versions') }}" class="px-8 py-4 bg-slate-900 text-white rounded-2xl font-black text-sm hover:bg-primary transition-all flex items-center gap-4 shadow-[0_20px_40px_-10px_rgba(15,23,42,0.3)] group active:scale-[0.98]">
            ...
            <div class="py-32 bg-white relative">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        <div class="lg:col-span-2 p-1 rounded-[2.5rem] bg-slate-50 border border-slate-100 group hover:bg-gradient-to-br hover:from-primary hover:to-indigo-600 transition-all duration-700">
                             <div class="bg-white p-10 rounded-[2.3rem] h-full flex flex-col items-start transition-all">
                                ...
                                <p class="text-slate-500 text-sm font-semibold leading-relaxed mb-10">
                                    İnternet koptuğunda kasanız asla durmaz. Tüm veriler lokalde işlenir.
                                </p>
                            </div>
                        </div>
                        
                        <div class="p-1 rounded-[2.5rem] bg-slate-50 border border-slate-100 group">
                            <div class="bg-white p-10 rounded-[2.3rem] h-full">
                                <div class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center mb-10">
                                    <i class="fas fa-bolt text-xl"></i>
                                </div>
                                <h3 class="text-2xl font-black text-slate-900 mb-6 uppercase">HIZLI</h3>
                        ...
                        <div class="p-1 rounded-[2.5rem] bg-slate-50 border border-slate-100 group">
                            <div class="bg-white p-10 rounded-[2.3rem] h-full">
                                 <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center mb-10">
                                    <i class="fas fa-shield-alt text-xl"></i>
                                </div>
                                <h3 class="text-2xl font-black text-slate-900 mb-6 uppercase">GÜVENLİ</h3>
            ...
            <div class="py-48 relative border-t border-slate-100 bg-white shadow-2xl overflow-hidden">
                <div class="mx-auto max-w-4xl px-6 text-center relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-6">
                        <a href="{{ route('pages.pos.versions') }}" class="px-12 py-5 bg-slate-900 text-white rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] hover:bg-primary transition-all flex items-center justify-center gap-4 shadow-2xl shadow-primary/20 group active:scale-[0.98]">
        ...
        <style>
            ...
            @keyframes pulse-slow { 0%, 100% { opacity: 0.1; transform: scale(1); } 50% { opacity: 0.4; transform: scale(1.1); } }
